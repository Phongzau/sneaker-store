...
<head>
    ...
    <title>Sneaker Store | Thông báo về chương trình ưu đãi</title>
                    ...
                    <tr>
                        ...
                        <td align="center" class="section-img">
                            <a href=""
                                ...
                                <img src="
                                {{-- {{ Storage::url($popupImage) }}" alt="{{ $popupTitle }} --}}
                                https://i.pinimg.com/736x/d3/b4/be/d3b4bed66f21e788b5bd3c39a11ddada.jpg
                                "
                    ...
                    <tr>
                        <td align="center"
                            ...
                            <div style="line-height: 35px">
                                ...
                                Chương trình ưu đãi mới <span style="color: #5caad2;">{{ $popupTitle }}</span>
                                ...
                                <tr>
                                    <td align="center"
                                        ...
                                        <div style="line-height: 26px;">
                                            <a href="{{ route('home') }}"
                                                style="color: #ffffff; text-decoration: none;">SHOP NOW</a>
                                        </div>
                                    </td>
                                </tr>
                                    ...
                                    <td align="left">
                                        <a href=""
                                            style="display: block; border-style: none !important; border: 0 !important;"><img
                                                ...
                                                src="https://mdbootstrap.com/img/logo/mdb-email.png
                                                {{-- {{ Storage::url(@$logoSetting->logo_footer) }} --}}
                                                "
                                                alt="" /></a>
                                    </td>
                                </tr>
                                    ...
                                    <td align="left"
                                        ...
                                        <div
                                            ...
                                            Email us: <br /> <a href="mailto:"
                                                style="color: #888888; font-size: 14px; font-family: 'Hind Siliguri', Calibri, Sans-serif; font-weight: 400;">{{ @$generalSettings->contact_email }}</a>
                                        ...
                                        <table border="0" align="right" cellpadding="0" cellspacing="0">
                                            <tr>
                                                ...
                                                @foreach ($socials as $social)
                                                    <td>
                                                        <a href="{{ $social->url }}" class="social-icon" target="_blank" style="display: block; border-style: none !important; border: 0 !important;">
                                ...
                                <tr>
                                    <td align="left"
                                        ...
                                        <div style="line-height: 24px;">
                                            ...
                                            <span style="color: #333333;">Copyright © 2024  Sneaker Store</span>
