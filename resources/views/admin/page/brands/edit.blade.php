            ...
            <div class="row">
                <div class="col-md-12 ">
                    <div class="card bg-light">
                        ...
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.brands.update', $brands->id) }}"
                                            ...
                                            <div class="card-body">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" name="description"
                                                        value="{{ $brands->description }}" class="form-control">
                                                </div>
                                                <div class="form-group ">
